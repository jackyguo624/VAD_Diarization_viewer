...
class PlotDiar:
    ...
    def draw(self):
        ...
        sample_rate, signal = scipy.io.wavfile.read(self.wav)  # File assumed to be in the same directory
        time=np.arange(0.0, len(signal)/sample_rate, 1/sample_rate)
        plot.plot(time, (signal+y) * 0.01)
